...
export function ServerHeader({ server, role }) {
    ...
    return (
        <DropdownMenu>
            ...
            >
                <button
                    className=" w-full text-center text-md font-semibold px-3 flex items-center min-h-12 dark:bg-[#031525]/80 dark:text-gray-200 bg-zinc-500/60  transition text-slate-700 capitalize"
                >
