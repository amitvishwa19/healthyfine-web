    ...
    return (
        <div className=' relative'>
            <footer>
                            ...
                            <div className="col-lg-12">
                                <div className="footer-top-content">
                                    <div className="footer-logo">
                                        {/* <a href="index.html">
                                            <Image className="img-fluid" src={require('../../../assets/images/devlomatix_dark.png')} alt="" height={40} />
                                        </a> */}
                                    </div>
                ...
                <div className="container">
                    <div className="flex flex-row row g-lg-4 gy-5 items-center justify-evenly">
                        <div className="col-lg-4 col-sm-6 d-flex">
                            <div className="footer-widget flex-col gap-4">
                                <div className="footer-contact mb-40">
                                    ...
                                    <div className='text-sm text-white/50'>102 Mark Avenue</div>
                                    <div className='text-sm text-white/50'>Harni,Vadodara,Gujarat</div>
                                </div>
                                <div className="footer-contact mb-40">
                                    <h4>
                                    ...
                                    <div className='dmmono text-white/50'>info@devlomatix.online</div>
                                </div>
                                <div className="footer-contact mt-4">
                                    {/* <h6>Subscribe for New updates</h6>
                                    <form>
                            ...
                            <div className="col-lg-12">
                                <div className="footer-btn-content">
                                    <div className="copyright-area">
                                        <p>©Copyright 2023 <a href="#">Devlomatix</a> | Design By <a
                                            href="https://www.devlomatix.online/">Devlomatix</a></p>
                                    </div>
