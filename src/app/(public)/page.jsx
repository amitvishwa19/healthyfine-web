    ...
    return (
        <div className=''>
            ...
            <div className=''>
                ...
                <div className='py-10 px-20 flex flex-row items-center justify-evenly'>
                                            ...
                                            <div className='flex flex-row gap-4' >
                                                <div>
                                                    <div className='p-4 rounded-full bg-[#162C41] hover:bg-[#0495FF] flex transition delay-150'>
                                                        <Image src={choose_icon01} height={150} />
                                                    </div>
                                                </div>
