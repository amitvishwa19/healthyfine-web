      ...
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
        ...
        <div className={cn("grid gap-6")}>
          ...
          <div className='flex justify-evenly'>
            <Button variant="outline" type="button" disabled={false} onClick={handleGoogleLogin}>
              <FcGoogle />
            </Button>

            <Button variant="outline" type="button" disabled={false} onClick={handleGithubLogin}>
              <FaGithub />
            </Button>
          </div>
